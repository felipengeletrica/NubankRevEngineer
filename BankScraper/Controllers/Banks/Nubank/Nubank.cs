...
namespace BankScraper.Controllers.Banks.Nubank
{
    ...
    public class Nubank 
    {
        ...
        private string user_agent = 
            "User-Agent: Android;Google Nexus 5 - 6.0.0 - API 23 - " +
            "1080x1920;Android;6.0;vbox86p-userdebug 6.0 MRA58K " +
            "eng.buildbot.20160110.195928 test-keys;mov-android-app;" +
            "6.14.0.1;en_US;cpu=0|clock=|ram=2052484 kB|espacoSDInterno=12.46 GB|" +
            "isSmartphone=true|nfc=false|camera=true|cameraFrontal=true|root=true|" +
